...
public:
	...
	CellPosition GetPosition() const;	// A Getter for the current cell position of the GameObject

	void SetPosition(const CellPosition&);	// A setter for the current cell position of the GameObject
